/**
 * Motor del Phishing Quiz - Versión Analítica Avanzada
 * Localización: ../assets/js/quiz.js
 */
...
let sessionAnalytics = {
    ...
    failedIds: {}         // Cuenta cuántas veces se falla cada ID de escenario
};
...
window.startQuiz = function() {
    ...
    if (!userAlias) { alert("No se puede dejar el campo vacío. Por favor, introduzca un nombre."); return; }
...
window.jumpToRanking = function() {
    ...
    document.getElementById('evaluation-text').innerHTML = "Panel de Estadísticas Globales";
    renderLeaderboard();
};
...
window.checkAnswer = function(choice) {
    ...
    if(isCorrect) {
        ...
        // Registrar ID fallado para estadística
...
function showFinalResults() {
    ...
    // 1. Identificar tendencia (Vector más fallado)
    ...
    // 2. Identificar el escenario más difícil de la sesión
